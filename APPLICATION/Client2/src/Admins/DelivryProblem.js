  ...
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="flex flex-wrap -m-4 text-center">
      <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
        ...
        src="https://image.spreadshirtmedia.com/image-server/v1/mp/compositions/T210A2MPA3176PT17X4Y38D1024191917FS3826/views/1,width=550,height=550,appearanceId=2,backgroundColor=F2F2F2/superadmin-super-admin-administrator-rules-tee-mens-t-shirt.jpg" alt="Logo" />
      ...
      <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
        <div class="border-2 border-gray-600 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
        <img className="h-16 w-16 rounded-full text-indigo-500 w-12 h-12 mb-3 inline-block " src="https://image.spreadshirtmedia.com/image-server/v1/mp/compositions/T210A2MPA3176PT17X4Y38D1024191917FS3826/views/1,width=550,height=550,appearanceId=2,backgroundColor=F2F2F2/superadmin-super-admin-administrator-rules-tee-mens-t-shirt.jpg" alt="Logo" />
                 <h1 class="title-font font-medium text-3xl text-gray-900">Yassine Cherkaoui </h1>
         <p> <a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=Yassin@gmail.com" class="leading-relaxed">Yassin@gmail.com</a></p>
          <p><a href="tel:0621114160" class="leading-relaxed">0621114160</a></p>
        </div>
