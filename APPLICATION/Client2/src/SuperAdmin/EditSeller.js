...
<div className="container mx-auto">
  <div className="flex justify-center px-6 my-12">
    ...
    <div className="w-full xl:w-3/4 lg:w-11/12 flex">
      {/* Col */}
      <div className="w-full h-auto bg-gray-400 hidden lg:block  bg-cover rounded-l-lg" style={{backgroundImage: 'url("https://adminheroblog.files.wordpress.com/2018/07/d33a7-zero-to-admin-hero-landing-page-mailerlite.jpg")'}} />
      {/* Col */}
