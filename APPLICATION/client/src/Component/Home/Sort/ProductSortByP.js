    ...
    <div className="container mx-auto flex items-center flex-wrap pt-4 pb-12">
      ...
      <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
        <a href="/">
          ...
          <Link onClick={() => Checkout(item._id)}><button class="bg-green hover:bg-green-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow content-center w-full mt-8">
            BUY
        </button></Link> 
        </a>
      </div>
