                  ...
                  <div className="col-span-2 p-5">
                    ...
                    <div className="flex justify-between items-center mt-6 pt-6 border-t">
                      <div className="flex items-center">
                        <div className="flex flex-col ml-3 "> <span className="text-md font-medium">Pack Pro</span> <span className="text-xs font-light text-gray-400">#12433</span> </div>
                      </div>
                      <div className="flex justify-center items-center">
                        <div className="pr-8"> <span className="text-xs font-medium">3000 MAD/Mo</span> </div>
                      </div>
                    </div>
                    <div className="flex justify-between items-center mt-6 pt-6 border-t">
